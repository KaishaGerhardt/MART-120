...
function draw()
{
    ...
    function enemys()
    {
        ...
        // draw the shape
        fill("red");
        rect(210, shapeYs, 50, 25); //bottom half of ghost
        ellipse(235, shapeYs, 50, 50); //top half of ghost
        fill("white"); //eye whites
        ellipse(225, shapeYs, 15, 15);
        ellipse(245, shapeYs, 15, 15);
        fill("blue");//blue part of eyes
        ellipse(245, shapeYs, 10, 10);
        ellipse(225, shapeYs, 10, 10);


        // Enemy 2
        fill("purple");
        rect(310, shapeYs, 50, 25); //bottom half of ghost
        ellipse(335, shapeYs, 50, 50); //top half of ghost
        fill("white"); //eye whites
        ellipse(325, shapeYs, 15, 15);
        ellipse(345, shapeYs, 15, 15);
        fill("blue");//blue part of eyes
        ellipse(345, shapeYs, 10, 10);
        ellipse(325, shapeYs, 10, 10);


        // Enemy 3
        fill("orange");
        rect(110, shapeYs, 50, 25); //bottom half of ghost
        ellipse(135, shapeYs, 50, 50); //top half of ghost
        fill("white"); //eye whites
        ellipse(125, shapeYs, 15, 15);
        ellipse(145, shapeYs, 15, 15);
        fill("blue");//blue part of eyes
        ellipse(145, shapeYs, 10, 10);
        ellipse(125, shapeYs, 10, 10);
